function [ input ] = ...
    initialiseInputs3level( whatTheFock1,whatTheFock2,numPulses,pulsePeriod,...
...
% tauDecay1 (NONRADIATIVE energy transition)
input(2,:) = input(2,:) - tauDecay1*log(rand(1,length(input(1,:))));
% Add time randomly drawn from exponential decay with decay lifetime
% tauDecay2 (RADIATIVE energy transition)
input(2,:) = input(2,:) - tauDecay2*log(rand(1,length(input(1,:))));
end
